...
function success_sqlSelect(transactionId, resultset) {
    if (resultset != null) {
        ...
        if (kony.os.deviceInfo().name == "Windows 8") frmWebSQL.segment21930040990147151.setData(insertTable);
        else frmWebSQLResults.segment21930040990147151.setData(insertTable);
    }
    if (kony.os.deviceInfo().name != "Windows 8") frmWebSQLResults.show();
}
/*****************************************************************
 *	Name    : sqlSelect
 *	Author  : Kony Solutions
