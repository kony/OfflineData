...
function addWidgetsfrmLocalStore() {
    var label1589408041146264 = new kony.ui.Label({
        "id": "label1589408041146264",
        "isVisible": true,
        "text": "Local Store",
    ...
    vbxClear);
    frmLocalStore.add(
    label1589408041146264, hbxSetItem, hbxGetItem, hbxReadKey, hbxRemoveItem, hbxClear);
};
...
function frmLocalStoreGlobals() {
    ...
    frmLocalStore = new kony.ui.Form2({
        ...
        "directChildrenIDs": ["hbxSetItem", "vbxSetItem", "lblSetItem", "hbxSetItemKeyValue", "txtSetItemkey", "txtSetItemValue", "hbxSetItemBtn", "btnSetItem", "hbxGetItem", "vbxGetItem", "lblGetItem", "hbxGetItemKey", "txtGetItemKey", "hbxGetItemBtn", "btnGetItem", "hbxReadKey", "vbxReadKey", "lblReadKey", "hbxReadKeyIndex", "txtReadKeyIndex", "hbxReadKeyBtn", "btnReadKey", "hbxRemoveItem", "vbxRemoveItem", "lblRemoveItem", "hbxRemoveItemKey", "txtRemoveItemKey", "hbxRemoveItemBtn", "btnRemoveItem", "hbxClear", "vbxClear", "lblClear", "lblClearMessage", "hbxClearBtn", "btnClear", "label1589408041146264"]
    });
};